...
//ORDER BY store.branch_name";
 ...
 $q = "SELECT distinct
    ...
    CONCAT(' ', S.branch_name) AS branch_name, S.store_id, INV.quantity, I.UPC
	
		FROM items AS I, store AS S, inventory as INV
		WHERE S.branch_name = '$bn' AND I.UPC = INV.UPC AND S.store_id = INV.store_id AND INV.Quantity < 50
 ...
 <td align=\"right\">{$row['quantity']}</td>
   <td align=\"center\"><a href='reorderRequest.php?UPC=". $row['UPC'] ."&store=". $row['store_id'] ."' title='Update Record' data-toggle='tooltip'>Order</a></td>
 </tr>\n";
...
<form enctype="multipart/form-data" action="reorder.php" method="POST">
